...
namespace RayTracer
{
	...
	{
        /**
		 * Set up the coefficients of a quartic equation for the intersection of the parametric equation P = vantage + u*direction and the  surface of the torus.
		 ...
		 * There can be significant roundoff error in quartic solver, so we have to tolerate more slop than usual.
		 */
