...
namespace RayTracer
{
	...
	{
        /**
		 * A color is valid for reflection if all its components are in the range 0..1.
		 * Otherwise, it is possible for multiple reflections to keep "amplifying" light beyond any limit.
		 */
		...
		const Color& rawGlossColor)
	{
		 ...
		 * Otherwise very high component values can defeat the purpose of trying to balance reflected light levels to realistic ranges.
		 */
		...
		// Scale the glossy and matte parts of reflected light so that an object does not reflect more light than hits it.
